...
export const Login = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-background-light dark:bg-background-dark py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      {/* Decorative Blurs */}
